    ...
    <div v-else-if="idea" class="space-y-6">
      ...
      <div class="glass-card p-6 flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <div v-else-if="isCreator">
          <span class="px-4 py-2 bg-slate-100 text-slate-500 font-medium rounded-lg cursor-not-allowed border border-slate-200">You created this</span>
        </div>
        <div v-else>
          <!-- If accepted -->
      ...
      <!-- WhatsApp Link Box -->
      <div v-if="idea.whatsapp_link && (isCreator || userRequestStatus === 'accepted')" class="glass-card p-6 bg-gradient-to-br from-emerald-50 to-teal-50 border-emerald-100 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
